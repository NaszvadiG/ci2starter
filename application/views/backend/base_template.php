...
<head>
	<title>Dashboard | CodeIgniter Starter</title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
		...
		<div class="sidebar">
			<div class="brand">
				<a href="<?php echo site_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/logo.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo site_url(); ?>" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li><a href="<?php echo site_url('layouts/index'); ?>" class=""><i class="lnr lnr-home"></i> <span>Dashboard Stats</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
				<!-- main content from controller here  -->
			...
			<footer>
				<div class="container-fluid">
					<p class="copyright">&copy; 2016. CodeIgniter Starter by <a href="https://github.com/cyberfly/ci2starter">Your Copyright</a></p>
				</div>
			</footer>
		</div>
		<!-- END MAIN -->
...
<script type="text/javascript">
	...
	$( document ).ready(function() {
		...
		$( ".delete" ).click(function(e) {
			...
			// prevent form from submit until user agree
			e.preventDefault();

			var answer = confirm("Delete this?");

			// if yes, resume submit form
			if (answer) {
