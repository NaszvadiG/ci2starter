...
--
-- Host: localhost
-- Generation Time: Feb 05, 2017 at 08:27 AM
...
(2, 'IT', 'Managing IT'),
(6, 'test department three', 'another new department');
...
CREATE TABLE `employees` (
  ...
  `department_id` int(5) DEFAULT NULL COMMENT 'foreign key from table departments',
  `job_id` int(5) NOT NULL COMMENT 'foreign key from table jobs',
  `user_id` int(5) DEFAULT NULL COMMENT 'foreign key from table users'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
